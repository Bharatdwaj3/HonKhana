    ...
    <header className="relative min-h-screen w-full flex bg-background overflow-hidden">
      ...
      >
        ...
        <div className="space-y-8">
          ...
          <Link to="/my-loans" className="flex items-center gap-3 text-xs font-semibold text-foreground/50 uppercase tracking-wider hover:text-secondary transition-colors cursor-pointer w-fit group">
